          ...
          <li>
            ...
            <div id="dropdownPropOptions" class="z-10 hidden bg-light-orange rounded-lg shadow">
              <ul class=" py-2 overflow-y-auto text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUsersButton">
                <li> 
					<router-link to="/compare"  class="block py-1 px-2 md:bg-light-orange md:text-white text-lg font-default-font">Compare</router-link>
				</li>
				<li>
					<router-link to="/listings" class="block py-1 px-2 md:bg-light-orange md:text-white text-lg font-default-font">Properties</router-link>
				</li>
				<li v-if="isLoggedIn">
					<router-link to="/revprop" class="block py-1 px-2 md:bg-light-orange md:text-white text-lg font-default-font">Review Property</router-link>
				</li>
				<li v-if="isLoggedIn && isLeasingCompany">
					<router-link to="/add-property" class="block py-1 px-2 md:bg-light-orange md:text-white text-lg font-default-font">Add Property</router-link>
				</li>
              </ul>
            </div>
          </li>
